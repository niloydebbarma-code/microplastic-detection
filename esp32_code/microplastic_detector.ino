 ...
 * 
 * Hardware: ESP32-CAM (AI-Thinker) with OV3660 3MP sensor
...
void setup() {
    ...
    // ========================================================================
    // Camera Configuration (AI-Thinker with OV3660)
    // ========================================================================
    ...
    // ========================================================================
    // Camera Sensor Settings (OV3660 optimized for holography)
    // ========================================================================
    ...
    Serial.println("========================================");
    #ifdef USE_AP_MODE
        Serial.printf("Web UI:     http://%s:81/\n", WiFi.softAPIP().toString().c_str());
        Serial.printf("Stream URL: http://%s:81/stream\n", WiFi.softAPIP().toString().c_str());
        Serial.printf("Status URL: http://%s:81/status\n", WiFi.softAPIP().toString().c_str());
    #else
